...
pub enum ExecuteMsg {
  ...
  // якщо ви хочете видалити/видалити колекцію, встановіть support_asset = vec![]
  // Причина, по якій я не поставив функцію remove_collection, полягає в тому, щоб уникнути помилки в уже зробленому порядку.
  UpdateCollection {
    nft_address: String,
  ...
  //купити nft за фіксованою ціною.
  ExecuteOrder {
    order_id: u64
  },

  // провести аукціон, термін дії якого закінчився.
  ExecuteAuction {
    order_id: u64
  },
