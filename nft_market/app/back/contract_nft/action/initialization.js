const { MsgInstantiateContract, isTxError } = require('@terra-money/terra.js');
const terra = require('../initialization/terra.js');
const wallet = require('../initialization/wallet.js');
const fs = require('fs');

let data_deploy = fs.readFileSync("app/back/contract_nft/contract_deploy.json");
...
exports.initialization_contract = async function(req, res) {
    ...
    fs.writeFileSync('app/back/contract_nft/contract_address.json', JSON.stringify(data));
};